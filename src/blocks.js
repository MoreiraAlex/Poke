...
const textures = {
  dirt: loadTexture('/Poke/textures/dirt.png'),
  grass: loadTexture('/Poke/textures/pack/grass/grass-1-flower.png'),
  ground: loadTexture('/Poke/textures/ground.png'),
  grassSide: loadTexture('/Poke/textures/grass_side.png'),
  coalOre: loadTexture('/Poke/textures/coal_ore.png'),
  ironOre: loadTexture('/Poke/textures/iron_ore.png'),
  stone: loadTexture('/Poke/textures/pack/rock-1/rock-2-4.png'),
  tree: loadTexture('/Poke/textures/tree.png'),
  leaves: loadTexture('/Poke/textures/leaves.png'),
  sand: loadTexture('/Poke/textures/pack/sand/sand-2.png'),
  bush: loadTexture('/Poke/textures/bush.png'),
  jungleTreeSide: loadTexture('/Poke/textures/jungle_tree_side.png'),
  jungleTreeTop: loadTexture('/Poke/textures/jungle_tree_top.png'),
  jungleLeaves: loadTexture('/Poke/textures/jungle_leaves.png'),
  cactusSide: loadTexture('/Poke/textures/cactus_side.png'),
  cactusTop: loadTexture('/Poke/textures/cactus_top.png'),
  snow: loadTexture('/Poke/textures/pack/snow/snow.png'),
  snowSide: loadTexture('/Poke/textures/snow_side.png'),
  water: loadTexture('/Poke/textures/waternormals.jpg'),
}
